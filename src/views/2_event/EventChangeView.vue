...
export default {
  ...
  data() {
    return {
      ...
      dongList: [
        { cityCode: '02', dongCode: '1', dongTitle: '강남구' },
        { cityCode: '02', dongCode: '2', dongTitle: '강동구' },
        { cityCode: '02', dongCode: '3', dongTitle: '강북구' },
        { cityCode: '02', dongCode: '4', dongTitle: '강서구' },
